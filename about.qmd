...
line_objects=plt.plot(ndvi_data['C0/date'], ndvi_data['C0/mean'], marker='o', linestyle='-', color='blue')
...
plt.figure(figsize=(10, 6))
line_objects=plt.plot(otci_data['C0/date'], otci_data['C0/mean'], marker='o', linestyle='-', color='green')
