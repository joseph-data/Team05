...
```{r setup}
library(reticulate)
py_install(c("pillow", "numpy", "geopandas", "folium", "fiona", "matplotlib", "pandas", "plotly", "ipython"), pip = TRUE)
...
# Create the static plot using matplotlib
plt.figure(figsize=(10, 6))
plt.plot(ndvi_data['C0/date'], ndvi_data['C0/mean'], marker='o', linestyle='-', color='blue')
...
# Convert 'C0/date' to a datetime and normalize time to midnight
otci_data['C0/date'] = pd.to_datetime(otci_data['C0/date']).dt.normalize()

# Create the static OTCI plot using matplotlib
plt.figure(figsize=(10, 6))
plt.plot(otci_data['C0/date'], otci_data['C0/mean'], marker='o', linestyle='-', color='green')
plt.title("OTCI", fontsize=16)
plt.xlabel("Date", fontsize=14)
plt.ylabel("OTCI", fontsize=14)
plt.xticks(rotation=45)
plt.grid(True)
plt.tight_layout()
